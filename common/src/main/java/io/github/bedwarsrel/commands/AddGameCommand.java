...
public class AddGameCommand extends BaseCommand {
    ...
    public boolean execute(CommandSender sender, ArrayList<String> args) {
        ...
        String levelName = args.get(0);
        Game addGame = this.getPlugin().getGameManager().addGame(levelName);
        this.getPlugin().setupGameName.put(sender.getName(), levelName);
        sender.sendMessage("你正在设置房间: " + levelName);
        ...
        sender.sendMessage(ChatWriter.pluginMessage(ChatColor.GREEN
                + BedwarsRel
                ._l(sender, "success.gameadded", ImmutableMap.of("game", levelName))));
        return true;
    }
